...
| `package-developer` | `app-admin` plus `packages.test`, `catalog.publish`, `communications.armada.write`, `memory.read`, `memory.write`, `memory.feedback` |
